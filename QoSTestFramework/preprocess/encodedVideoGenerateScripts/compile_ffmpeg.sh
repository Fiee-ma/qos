...
install_ffmpeg(){
  ...
  pushd ${DIR}
  PKG_CONFIG_PATH=${DOWNLOAD_DIR}/lib/pkgconfig CFLAGS=-fPIC ./configure --prefix=${DOWNLOAD_DIR} --enable-shared --disable-static --disable-opencl --disable-vaapi --enable-gpl --enable-libx264  --enable-nonfree --enable-pic && \
