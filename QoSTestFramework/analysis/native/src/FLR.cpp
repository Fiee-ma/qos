...
int main(int argc, char *argv[])
{
    ...
    for (int i = 2; i < datas.size(); i++)
    {
        ...
        if (inter < 0)
        {
            cout << abs((int)((datas[i].first - datas[i - 1].first) / (inter + framenumber))) << endl;
            jitter_out << abs((int)((datas[i].first - datas[i - 1].first) / (inter + framenumber)));
        }
        else
        {

            cout << abs((int)((datas[i].first - datas[i - 1].first) / (inter))) << endl;
            jitter_out << abs((int)((datas[i].first - datas[i - 1].first) / (inter)));
        }
